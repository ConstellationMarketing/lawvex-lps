...
export const CriminalDefenseServicesSection = (): JSX.Element => {
  const practiceAreas = [
    ...
    { title: "Probate Assistance", description: "Help for executors when a loved one has passed away with assets that need court administration." },
        ...
        <div className="mt-16 bg-lawvex-accent rounded-lg p-12 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="font-body text-white text-base space-y-2">
              <p>
                <strong>Request a Professional Fee Quote Today 559-418-6587</strong> <em>Speak with our intake team today to find out your exact cost before you schedule an attorney consultation.</em>
              </p>
            </div>
          </div>
        </div>
